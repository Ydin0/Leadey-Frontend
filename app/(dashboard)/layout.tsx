            ...
            <div className="min-h-screen dashboard-backdrop bg-page">
              ...
              <main className="ml-[56px] mt-14 h-[calc(100vh-3.5rem)] flex flex-col">
                ...
                {/* overflow-x-hidden stops any hair-too-wide child from adding a
                    ...
                    content (tables) scrolls inside its own container. Kept a
                    plain block (not flex) so pages that centre with max-w+mx-auto
                    still stretch to their max-width instead of shrinking to
                    content, and full-height views set their own explicit height. */}
