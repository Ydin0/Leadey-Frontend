  ...
  return (
    <div className="mb-4 space-y-2">
      ...
      <div className="flex items-center gap-1.5 flex-wrap">
        ...
        {/* Custom employee headcount min/max (high & low) — plain numeric text
            inputs (no spinner arrows) so typing isn't fiddly. */}
        <div className="flex items-center gap-1 px-2 py-1 rounded-[8px] border border-border-subtle bg-section/40">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              updateFilter("minEmployees", d === "" ? null : Number(d));
            }}
          ...
          <input
            ...
            onChange={(e) => {
              const d = e.target.value.replace(/[^0-9]/g, "");
              updateFilter("maxEmployees", d === "" ? null : Number(d));
            }}
            className="w-16 px-2 py-0.5 rounded-[6px] bg-surface border border-border-subtle text-[11px] text-ink text-center outline-none focus:border-border-default"
          />
        </div>
